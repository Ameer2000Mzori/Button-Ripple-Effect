...
> Button-Ripple-Effect is a small website created with HTML, SCSS, and TypeScript. When clicking on the button, a ripple effect appears, and it utilizes the DOM to create all the effects. Please check out the live demo.
...
- [Live Demo Link](https://ameer2000mzori.github.io/Button-Ripple-Effect/src/)
